    ...
    <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
      ...
      catch(PDOEXCEPTION $e)
      {
         ...
         <br></br>
             ...
             <i class="bi bi-heart-pulse"> Total Especialidad</i>
              <?php
              $db_host="localhost"; 
              $db_user="root";    
              $db_password="";    
              ...
              $sql = "SELECT COUNT(*) total FROM especialidad";
              $result = $db->query($sql);
              $total = $result->fetchColumn();
              ?>
                        <?php echo  $total; ?>
              ...
              <i class="bi bi-people"> Total de Usuarios</i>
              <?php
              $db_host="localhost"; 
              $db_user="root";    
              $db_password="";    
              ...
              <i class="bi bi-cash-stack"> Total de Gastos Q. </i>
              <?php
              $db_host="localhost"; 
              $db_user="root";    
              $db_password="";    
              ...
              $sql = "SELECT SUM(cantidad) total FROM gastos";
              $result = $db->query($sql);
              $total = $result->fetchColumn();
              ?>
                              <?php echo  $total; ?><a>.00</a>
