                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingresar Medicamentos</h1>
                                ...
                                <form action="insertar_medicamentos.php" method="POST">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizar_medicamentos.php?id=<?php echo $row['id_medicamento'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="eliminar_medicamentos.php?id=<?php echo $row['id_medicamento'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
