                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingresar Donacion</h1>
                                ...
                                <form action="insertar_donacioneslabo.php" method="POST">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizar_donacioneslabo.php?id=<?php echo $row['id_donaciones'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="eliminar_donacioneslabo.php?id=<?php echo $row['id_donaciones'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
