                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingresar Gastos</h1>
                                ...
                                <form action="insertar_gastos.php" method="POST">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizar_gastos.php?id=<?php echo $row['id_gastos'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="eliminar_gastos.php?id=<?php echo $row['id_gastos'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
