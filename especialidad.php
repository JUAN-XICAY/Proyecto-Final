                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingresar Especialidad</h1>
                                ...
                                <form action="insertar_especialidad.php" method="POST">

                                    <input type="text" class="form-control mb-3" name="nombre_especialidad" placeholder="Nombre Especialidad">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php  echo $row['fecha_creada']?></th>


                                                
                                
                                                <th><a href="actualizar_especialidad.php?id=<?php echo $row['codigo'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="eliminar_especialidad.php?id=<?php echo $row['codigo'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
